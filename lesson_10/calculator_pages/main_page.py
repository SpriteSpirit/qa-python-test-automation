...
class CalculatorPage:
    ...
    @allure.step("Ожидание загрузки результата и проверки содержания текста")
    ...
    @allure.step("Клик на кнопку калькулятора")
    ...
    @allure.step("Установка задержки выполнения операции калькулятора (время в с.)")
